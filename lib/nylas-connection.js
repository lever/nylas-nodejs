...
(function() {
  var Account, Attributes, Calendar, Contact, Delta, Draft, Event, File, Folder, Label, ManagementAccount, ManagementModelCollection, Message, NylasConnection, Promise, RestfulModel, RestfulModelCollection, RestfulModelInstance, Tag, Thread, clone, logOnError, request, _;
      ...
      return new Promise(function(resolve, reject) {
        return request(options, function(error, response, body) {
          ...
          if (error || response.statusCode > 299) {
            if (!error) {
              if (_.isString(body != null ? body.message : void 0)) {
                error = new Error(body != null ? body.message : void 0);
              } else {
                error = new Error(JSON.stringify(body != null ? body.message : void 0));
              }
            }
            if (body != null ? body.type : void 0) {
              error.code = body.type;
            }
            if (body != null ? body.server_error : void 0) {
